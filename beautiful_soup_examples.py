from bs4 import BeautifulSoup # python's way for scraping webpages
import numpy as np
import pandas as pd
import re
import requests
...
hot100_req = requests.get(link) # request = get it..

# Injests the html into a BeautifulSoup object

hot100_soup = BeautifulSoup(hot100_req.content) # now will scrape it. 
#pull all the stuff we may want to use
...
# got the 100 songs, translating it to list comprehension so u can pull thetext out of those elements
# .text will make it to text. 
