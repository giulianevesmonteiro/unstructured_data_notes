...
```{python}
import requests
college_k = "mqOl7w28fzwRrdLdzhVdZFhYoPN7duXn9pnAlFJq"

college_name = "Harvard University"

college_link = "https://api.data.gov/ed/collegescorecard/v1/schools?api_key={}&school.name={}".format(college_k, college_name)


college_request = requests.get(college_link) # pulls/gets the info

college_json = college_request.json() # making it into a json
